          ...
          <div className="grid grid-cols-12">
            <div className="col-span-6  md:col-span-6 lg:col-span-6">
              <div className="flex items-center gap-2">
                ...
                <div className="flex flex-col text-white">
                  <h1 className="font-semibold">Ayu Agronom</h1>
                </div>
              </div>
            </div>
            <div className="col-span-6 flex justify-end items-center  md:col-span-6 lg:col-span-6">
              <button
                ...
                className="px-4 py-2 rounded-md text-sm bg-button font-semibold hover:bg-buttonHover hover:text-white transition duration-500"
              >
                Log out
              </button>
            </div>
